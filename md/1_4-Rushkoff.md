...
> game into a set that favors your strengths.[^1_4-Rushkoff_1]
>
...
biases of centralized currency and monopolies as rules of a game.[^1_4-Rushkoff_2]
...
game and rewrite the rules themselves – thus redefining the biases.[^1_4-Rushkoff_3]
...
aware of their freedom to choose whether or not to play.[^1_4-Rushkoff_4] Players are
also aware of the guiding rules of play, including boundaries such as
physical demarcations, time constraints, and behavioral procedures.[^1_4-Rushkoff_5]
...
for the debt on which the top-heavy game is based.)[^1_4-Rushkoff_6] People can
develop local and complementary currencies,[^1_4-Rushkoff_7] barter networks,[^1_4-Rushkoff_8] and
...
currency for daily transactions.[^1_4-Rushkoff_9] Local currency worked very
...
the farmer ‘spent’ the grain stored in his name.[^1_4-Rushkoff_11] In the Middle
Ages, the money was mostly made of precious metal banged into thin foil
coins – *brakteaten* – which could be torn into smaller segments.[^1_4-Rushkoff_12]
...
We can reframe this analysis in the language of media ecology,[^1_4-Rushkoff_13] that
...
by farmers and other laborers on behalf of future generations.[^1_4-Rushkoff_14]
...
to an expanded awareness of the value of that sharing.’[^1_4-Rushkoff_15] Open source
...
development of their science.[^1_4-Rushkoff_16] The creativity that was necessary to
...
collaboration with independent, autonomous development.[^1_4-Rushkoff_17] Many
...
community’[^1_4-Rushkoff_18] which ‘nobody owns, everybody can use and anybody can
improve.’[^1_4-Rushkoff_19]
...
pieces such as ‘Open Source Everywhere’[^1_4-Rushkoff_20] and ‘Collaborative
Culture’, suggesting that the proprietary way of doing things may have
run its course.[^1_4-Rushkoff_21]
...
source is the ethos of the bottom-up bazaar.[^1_4-Rushkoff_22]
...
Squared’[^1_4-Rushkoff_23] has been met by an overwhelming concentration of corporate
...
developing.[^1_4-Rushkoff_24] As a result, whatever visions or agendas these
...
programming abilities are applied to wholly different projects.[^1_4-Rushkoff_25]
...
culture guru Jeff Howe as ‘crowdsourcing’[^1_4-Rushkoff_27] through which
corporations can once again harness the tremendous potential of real
people acting in concert, for free. My own concept of ‘viral media’[^1_4-Rushkoff_28]
...
through which people develop non-monetary value’,[^1_4-Rushkoff_29] is now the name
...
[^1_4-Rushkoff_1]: Robert Young, ‘Giving it Away: How Red Hat Software Stumbled
...
[^1_4-Rushkoff_2]: Jos de Mul, ‘The Game of Life: Narrative and Ludic Identity
...
[^1_4-Rushkoff_3]: James P. Carse, *Finite & Infinite Games: A Vision of Life in Play
...
[^1_4-Rushkoff_4]: Johan Huizinga, *Homo Ludens: A Study of the Play-Element in
    Culture,* Boston: Beacon Press, 1971, p. 7.

[^1_4-Rushkoff_5]: Carse, *Finite & Infinite Games*, 1986, p. 9.

[^1_4-Rushkoff_6]: See Rushkoff, 2009.

[^1_4-Rushkoff_7]: Carse, *Finite & Infinite Games*, 1986.

[^1_4-Rushkoff_8]: See http://www.itex.com.

[^1_4-Rushkoff_9]: Bernard Lietaer, *The Mystery of Money: Beyond Greed and
    Scarcity,* Munich: Riemann Verlag, 2000, p. 183.

[^1_4-Rushkoff_10]: Bernard Lietaer and Stephen M. Belgin, *Of Human Wealth: Beyond
    Greed &* *Scarcity,* Boulder, CO: Human Wealth Books and Talks,
    2004, p. 104.

[^1_4-Rushkoff_11]: Lietaer, *The Mystery of Money*, 2000, p. 88.

[^1_4-Rushkoff_12]: Frank Berger, *Die Mittelalterlichen Brakteaten im
    Kestner-Museum, Hannover 2,* Hannover: Teil, 1996, p. 9.

[^1_4-Rushkoff_13]: Neil Postman and Charles Weingartner, *Teaching As a Subversive
    Activity,* New York: Delacorte Press, 1969.

[^1_4-Rushkoff_14]: Lietaer, *The Mystery of Money*, p. 145.

[^1_4-Rushkoff_15]: Tim O’Reilly, ‘The Open Source Paradigm Shift’, in Chris DiBona,
    Danese Cooper, and Mark Stone (eds) *Open Sources 2.0,* Sebastopol,
    CA: O’Reilly, 2006, p. 255.

[^1_4-Rushkoff_16]: For the history of Open Source, told by an assortment of its
    early participants, see DiBona, Ockman and Stone, 1999.

[^1_4-Rushkoff_17]: As well as a central, overseeing arbiter meant to stand in for
    the user and judge the contributions of the many.

[^1_4-Rushkoff_18]: O’Reilly, ‘Open Source’ 2006, p. 260.

[^1_4-Rushkoff_19]: Doc Searls and David Weinberger, ‘World of Ends What the Internet
    Is and How to Stop Mistaking It for Something Else’, 10 March 2003,
    http://worldofends.com.

[^1_4-Rushkoff_20]: Thomas Goetz, ‘Open Source Everywhere*’, Wired*, November 2003,
    http://www.wired.com/wired/archive/11.11/opensource.html.

[^1_4-Rushkoff_21]: D. Wolk, ‘Future of Open Source: Collaborative Culture’*, Wired*
    (June 2009):
    http://www.wired.com/dualperspectives/article/news/2009/06/dp\_opensource\_wired0616.

[^1_4-Rushkoff_22]: Eric S. Raymond, *Cathedral and Bazaar,* Cambridge, MA: O’
    Reilly, 2001.

[^1_4-Rushkoff_23]: Tim O’Reilly and John Battelle, ‘Web Squared: Web 2.0 Five Years
    On’, *Web 2.0 Summit,* 10 October 2009,
    http://www.web2summit.com/web2009/public/schedule/detail/10194

[^1_4-Rushkoff_24]: Matt Rosoff, ‘Google’s 15 Biggest Acquisitions and What Happened
...
[^1_4-Rushkoff_25]: As just one example, the purchase of Dodgeball by Google in 2005.

[^1_4-Rushkoff_26]: Thomas Frank, *The Conquest of Cool,* Chicago: University of
    Chicago Press, 1997.

[^1_4-Rushkoff_27]: Jeff Howe, ‘The Rise of Crowd Sourcing’, *Wired*, June 2006.

[^1_4-Rushkoff_28]: Douglas Rushkoff, *Media Virus.* New York: Ballantine Books,
    1994.

[^1_4-Rushkoff_29]: Rushkoff, *Get Back in the Box*, 2005, p. 78.
