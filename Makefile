...
book.epub: clean $(allmarkdown) book.md epub/metadata.xml epub/styles.epub.css epub/cover.png
	cd md && pandoc \
		...
		--epub-embed-font=../lib/lato-v11-latin-300.woff \
		--epub-embed-font=../lib/lato-v11-latin-300italic.woff \
		--epub-embed-font=../lib/lato-v11-latin-700.woff \
		--epub-embed-font=../lib/lato-v11-latin-700italic.woff \
		-o ../book.epub \
		book.md ; \
	cd ../ ; \
